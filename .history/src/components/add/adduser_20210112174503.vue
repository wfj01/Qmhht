    ...
    <el-dialog title="添加用户信息" :visible.sync="dialogAdd.show" width="40%">
      <el-form :model="formDate" ref="formdong" label-width="100px" :rules="formrules">
        ...
        <el-form-item label="姓名" prop="name">
          <el-input v-model="formDate.name" style="width:150px"></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop="mail">
          <el-input v-model="formDate.mail" style="width:150px"></el-input>
        </el-form-item>
        <el-form-item label="标题" prop="title">
          <el-input v-model="formDate.title" style="width:150px"></el-input>
        </el-form-item>
        <el-form-item label="评价" prop="description">
          <el-input v-model="formDate.description" style="width:150px"></el-input>
        </el-form-item>
        <el-form-item label="状态" prop="status">
          <el-input v-model="formDate.status" style="width:150px"></el-input>
        </el-form-item>
      </el-form>
