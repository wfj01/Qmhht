 <template>
  <div>
    ...
    >
      ...
      :filters="sourceList" :filter-method="filterHandler" column-key="source">
      </el-table-column>
      <el-table-column
        prop="jianjie"
        label="简介"
...
export default {
  ...
  methods: {
    ...
    filterHandler(value, row, column) {
      ...
      console.log("value",value,row,column,property,this.totalSum[property] === value)
      return this.totalSum[property] === value;
    },
  },
};
</script>
