  ...
  <div>
    ...
    >
      ...
      <el-form-item label="版本号2" prop="versionnum">
        <el-input v-model="form.versionnum" placeholder="(如100...)"></el-input>
      </el-form-item>
      ...
      this.$post({
        ...
        .then((res) => {
          if (res.isSuccess == true) {
            that.form.fileurl = res.filePathArray[0].filePath;
