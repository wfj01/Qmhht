  ...
  <div>
    ...
    >
      ...
      <el-table-column label="查看评价" width="100"
        >
        <template  slot-scope="scope"><el-button @click="LookPinglun(scope.row)">
          详情
...
export default {
  ...
  methods: {
    ...
    LookPinglun: function (row) {
        console.log(row.pingjia,row.pingfen,row.pingjiaimage,row.pingjiadate)
      this.pingjia = row.pingjia;
      this.pingfen = row.pingfen;
      this.pingjiaimage = JSON.parse(row.pingjiaimage);
