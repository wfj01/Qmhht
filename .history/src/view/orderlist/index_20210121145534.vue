<template>
  <div>
    <el-table :data="tableData" style="width: 100%">
      <el-table-column prop="username" label="客户昵称" width="180">
      </el-table-column>
      ...
      <el-table-column prop="windows" label="购买窗口" width="180">
      </el-table-column>
      <el-table-column prop="time" label="所需时间" width="180">
      </el-table-column>
      <el-table-column prop="price" label="商品单价" width="180">
      </el-table-column>
      <el-table-column prop="sumprice" label="商品总价" width="180">
      </el-table-column>
      <el-table-column
        prop="number"
        label="商品数量"
