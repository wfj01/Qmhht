<template>
  <div>
    ...
    >
      ...
      @click="LookPinglun(scope.row.pingjia,scope.row.pingfen,scope.row.pingjiaimage,scope.row.pingjiadate)"
        >详情</el-table-column
      >
      <el-table-column
        fixed="right"
    ...
    >
      <div>
        ...
        <el-form-item label="客户晒图">
          <div v-for="(item,index) in pingjiaimage" :key="index">
            <el-image
...
export default {
  ...
  methods: {
    ...
    // 查看评价
    LookPinglun:function(pingjia,pingfen,pingjiaimage,pingjiadate){
        this.pingjia = pingjia;
        this.pingfen = pingfen;
        this.pingjiaimage = JSON.parse(pingjiaimage);
        this.pingjiadate = this.$gettime(pingjiadate);
